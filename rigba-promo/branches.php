...
<!-- BEGIN FIXED-BG -->
<div class="fixed-bg-branches"></div>
<!-- END FIXED-BG -->
<div class="container">
    <h1 class="bold">SUCURSALES</h1>
</div>
<!-- BEGIN SUCURSALES MAPS -->
<div class="tab-content">
    <div role="tabpanel" class="tab-pane fade in active" id="chihuahua">
        <div class="container">
            <div class="row vertmargin-medium">
                <div class="col-sm-3 col-md-2">
                    <h2 class="orange">Chihuahua</h2>
                    <ul class="plain-list">
                ...
                <div class="col-sm-9 col-md-10">
                    <div class="map">
                        <iframe width='100%' height='750px' frameBorder='0' src='https://a.tiles.mapbox.com/v4/mixen.mfncobnc/attribution,zoompan,zoomwheel,geocoder,share.html?access_token=pk.eyJ1IjoibWl4ZW4iLCJhIjoiMWZlY2QzMzg0ZDk4YzdhNTA5ZDVhNzQxYjNhNDM5NTYifQ.JwnhsKIP5UnO-2WFreNSNQ'></iframe>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div role="tabpanel" class="tab-pane fade" id="nuevo-leon">
        <div class="container">
            <div class="row vertmargin-medium">
                ...
                <div class="col-sm-9 col-md-10">
                    <div class="map">
                        <iframe width='100%' height='750px' frameBorder='0' src='https://a.tiles.mapbox.com/v4/mixen.mfo2l8h0/attribution,zoompan,zoomwheel,geocoder,share.html?access_token=pk.eyJ1IjoibWl4ZW4iLCJhIjoiMWZlY2QzMzg0ZDk4YzdhNTA5ZDVhNzQxYjNhNDM5NTYifQ.JwnhsKIP5UnO-2WFreNSNQ'></iframe>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div role="tabpanel" class="tab-pane fade" id="coahuila">
        <div class="container">
            <div class="row vertmargin-medium">
                ...
                <div class="col-sm-9 col-md-10">
                    <div class="map">
                        <iframe width='100%' height='750px' frameBorder='0' src='https://a.tiles.mapbox.com/v4/mixen.mfo2i6l9/attribution,zoompan,zoomwheel,geocoder,share.html?access_token=pk.eyJ1IjoibWl4ZW4iLCJhIjoiMWZlY2QzMzg0ZDk4YzdhNTA5ZDVhNzQxYjNhNDM5NTYifQ.JwnhsKIP5UnO-2WFreNSNQ'></iframe>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div role="tabpanel" class="tab-pane fade" id="sonora">
        <div class="container">
            <div class="row vertmargin-medium">
                ...
                <div class="col-sm-9 col-md-10">
                    <div class="map">
                        <iframe width='100%' height='750px' frameBorder='0' src='https://a.tiles.mapbox.com/v4/mixen.mfo30816/attribution,zoompan,zoomwheel,geocoder,share.html?access_token=pk.eyJ1IjoibWl4ZW4iLCJhIjoiMWZlY2QzMzg0ZDk4YzdhNTA5ZDVhNzQxYjNhNDM5NTYifQ.JwnhsKIP5UnO-2WFreNSNQ'></iframe>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div role="tabpanel" class="tab-pane fade" id="durango">
        <div class="container">
            <div class="row vertmargin-medium">
                ...
                <div class="col-sm-9 col-md-10">
                    <div class="map">
                        <iframe width='100%' height='750px' frameBorder='0' src='https://a.tiles.mapbox.com/v4/mixen.mfo2og19/attribution,zoompan,zoomwheel,geocoder,share.html?access_token=pk.eyJ1IjoibWl4ZW4iLCJhIjoiMWZlY2QzMzg0ZDk4YzdhNTA5ZDVhNzQxYjNhNDM5NTYifQ.JwnhsKIP5UnO-2WFreNSNQ'></iframe>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div role="tabpanel" class="tab-pane fade" id="sinaloa">
        <div class="container">
            <div class="row vertmargin-medium">
                ...
                <div class="col-sm-9 col-md-10">
                    <div class="map">
                        <iframe width='100%' height='750px' frameBorder='0' src='https://a.tiles.mapbox.com/v4/mixen.mfo31k71/attribution,zoompan,zoomwheel,geocoder,share.html?access_token=pk.eyJ1IjoibWl4ZW4iLCJhIjoiMWZlY2QzMzg0ZDk4YzdhNTA5ZDVhNzQxYjNhNDM5NTYifQ.JwnhsKIP5UnO-2WFreNSNQ'></iframe>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div role="tabpanel" class="tab-pane fade" id="usa">
        <div class="container">
            <div class="row vertmargin-medium">
                ...
                <div class="col-sm-9 col-md-10">
                    <div class="map">
                        <iframe width='100%' height='750px' frameBorder='0' src='https://a.tiles.mapbox.com/v4/mixen.mfo364i3/attribution,zoompan,zoomwheel,geocoder,share.html?access_token=pk.eyJ1IjoibWl4ZW4iLCJhIjoiMWZlY2QzMzg0ZDk4YzdhNTA5ZDVhNzQxYjNhNDM5NTYifQ.JwnhsKIP5UnO-2WFreNSNQ'></iframe>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div role="tabpanel" class="tab-pane fade" id="china">
        <div class="container">
            <div class="row vertmargin-medium">
                ...
                <div class="col-sm-9 col-md-10">
                    <div class="map">
                        <iframe width='100%' height='750px' frameBorder='0' src='https://a.tiles.mapbox.com/v4/mixen.mfo338nm/attribution,zoompan,zoomwheel,geocoder,share.html?access_token=pk.eyJ1IjoibWl4ZW4iLCJhIjoiMWZlY2QzMzg0ZDk4YzdhNTA5ZDVhNzQxYjNhNDM5NTYifQ.JwnhsKIP5UnO-2WFreNSNQ'></iframe>
                    </div>
                </div>
            </div>
        </div>
...
<!-- END SUCURSALES MAP -->
<!-- BEGIN STATES CONTROLS -->
<div class="container-fluid red-orange-bg">
    <div class="center-block nav nav-tabs">

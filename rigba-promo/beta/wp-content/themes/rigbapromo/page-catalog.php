...
<div id="catalog">
	...
	<?php for($i = 0; $i < $arraySize; $i++) { ?>
		...
		<div class="col-sm-4">
			...
			<p class="vertmargin-tiny bold yellow"><?php echo $catalogArray[$i]['catalog_title']; ?></p>
			<div class="center-block slight-border"></div>
			<p><?php echo $catalogArray[$i]['catalog_description']; ?><br><span class="yellow">Categoría:</span> <i><?php echo $catalogArray[$i]['catalog_category']; ?></i></p>
		</div>			

            ...
            <div id="products">
               ...
               <div class="row">
                   <div class="col-sm-6 col-md-3">
                       <div class="product">
                           <img src="img/content/products/pencils.png" alt="Plumas">
                           <p>Plumas</p>
                           <p class="price">$50</p>
                           <div class="center-block">
                               <a href="product-page.php" class="btn orange-btn">Ver Producto</a>
                           </div>
                       </div>
                   </div>
                   <div class="col-sm-6 col-md-3">
                       <div class="product">
                           <img src="img/content/products/termos.png" alt="Termos">
                           <p>Termos</p>
                           <p class="price">$50</p>
                           <div class="center-block">
                               <a href="product-page.php" class="btn orange-btn">Ver Producto</a>
                   ...
                   <div class="col-sm-6 col-md-3">
                       <div class="product">
                           <img src="img/content/products/umbrella.png" alt="Sombrilla">
                           <p>Sombrilla</p>
                           <p class="price">$50</p>
                           <div class="center-block">
                               <a href="product-page.php" class="btn orange-btn">Ver Producto</a>
                   ...
                   <div class="col-sm-6 col-md-3">
                       <div class="product">
                           <img src="img/content/products/cups.png" alt="Tazas">
                           <p>Tazas</p>
                           <p class="price">$50</p>
                           <div class="center-block">
                               <a href="product-page.php" class="btn orange-btn">Ver Producto</a>

...
<div id="branches">
	<div class="container">
		...
		<div class="row negativemargin">
			<div class="col-sm-3">
				<h2 class="pink-purple opensans bold left-align">Selecciona una Sucursal</h2>
				<!-- BEGIN CONTROLS -->
				...
				<div class="tab-content">
					<div role="tabpanel" class="tab-pane fade in active" id="chihuahua">
						...
						<div class="row">
							<div class="col-sm-4">
								<ul class="plain-list">
									<li><strong><span class="pink-purple">Sucursal Berlín</span></strong></li>
							...
							<div class="col-sm-4">
								<ul class="plain-list map-data border">
									<li><strong><span class="pink-purple">Sucursal Industrias</span></strong></li>
									<li><strong>Colonia:</strong></li>
							...
							<div class="col-sm-4">
								<ul class="plain-list">
									<li><strong><span class="pink-purple">Sucursal Juárez</span></strong></li>
									<li><strong>Colonia:</strong></li>
									<li>La Cuesta</li>
									<li><strong>Calle:</strong></li>
					...
					<div role="tabpanel" class="tab-pane fade" id="nuevo-leon">
						...
						<ul class="plain-list">
							<li><strong><span class="pink-purple">Sucursal Nuevo León</span></strong></li>
							<li><strong>Colonia:</strong></li>
					...
					<div role="tabpanel" class="tab-pane fade" id="coahuila">
						...
						<ul class="plain-list">
							<li><strong><span class="pink-purple">Sucursal Coahuila</span></strong></li>
							<li><strong>Colonia:</strong></li>
					...
					<div role="tabpanel" class="tab-pane fade" id="sonora">
						...
						<ul class="plain-list">
							<li><strong><span class="pink-purple">Sucursal Sonora</span></strong></li>
							<li><strong>Colonia:</strong></li>
							<li>El Llano</li>
							<li><strong>Calle:</strong></li>
					...
					<div role="tabpanel" class="tab-pane fade" id="durango">
						...
						<ul class="plain-list">
							<li><strong><span class="pink-purple">Sucursal Durango</span></strong></li>
							<li><strong>Colonia:</strong></li>
					...
					<div role="tabpanel" class="tab-pane fade" id="sinaloa">
						...
						<ul class="plain-list">
							<li><strong><span class="pink-purple">Sucursal Sinaloa</span></strong></li>
							<li><strong>Colonia:</strong></li>
							<li>San Rafael</li>
							<li><strong>Calle:</strong></li>
					...
					<div role="tabpanel" class="tab-pane fade" id="usa">
						...
						<ul class="plain-list">
							<li><strong><span class="pink-purple">Sucursal El Paso</span></strong></li>
					...
					<div role="tabpanel" class="tab-pane fade" id="china">
						...
						<ul class="plain-list">
							<li><strong><span class="pink-purple">Sucursal China</span></strong></li>
							<li><strong>Ciudad:</strong></li>

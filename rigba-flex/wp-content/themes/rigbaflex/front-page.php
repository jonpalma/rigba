...
<!-- BEGIN ABOUTUS -->
<div class="container">
    <h2 class="blue uppercase vertmargin-big"><?php echo CFS()->get('about_us_header'); ?></h2>
			...
			<?php foreach($branchesArray as $branch) { ?>
            	<div class="branch-states-index">
            	   	<a href="<?php echo $branch['branch_link'] ?>">
                   		<img src="<?php echo $branch['branch_image_main'] ?>" alt="<?php echo $branch['branch_text_main'] ?>">
                   		<p class="white uppercase"><?php echo $branch['branch_text_main'] ?></p>
                	</a>
            	</div>
			<?php } ?>
        </div>
...
<div class="container vertpadding-big">
    <div class="row">
        <h3 class="purple uppercase"><?php echo CFS()->get('help_heading'); ?></h3>
        <p class="small blue vertmargin-tiny"><?php echo CFS()->get('help_text'); ?></p>
        <div class="center-block vertmargin-small">
            <a href="<?php echo CFS()->get('help_link'); ?>" class="btn purple-btn huge"><?php echo CFS()->get('help_button'); ?></a>
        </div>
    </div>
</div>
<!-- END HELP -->
